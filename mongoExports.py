...
client = MongoClient("mongodb+srv://connor24h:-PASSWORD-REMOVED-AFTER-HOWDYHACK-@cluster0.dxcpr.mongodb.net/Passwords?retryWrites=true&w=majority", authSource = "admin")
# =============================================================================================================================================
